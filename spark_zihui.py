...
def notNone(tweet):
  return tweet[0] is not None and tweet[1] is not None and tweet[2] is not None and tweet[3] is not None and tweet[4] is not None and tweet[5] is not None and tweet[6] is not None
